###  Lab 07: Application & Tips: 학습률(Learning Rate)과 데이터 전처리(Data Preprocessing)

---

- Learning rate

  - 3e-4 is the best learning rate for Adam (0.003)

    ![img](../resources/img/0531/img1.png)

  - Learning rate decay

    - Learning rate 값을 상황에 따라 유기적으로 바꾸는 것

      ![img](../resources/img/0531/img2.png)

- Data preprocessiong

  - 불필요한 데이터를 없애준다.

    ![img](../resources/img/0531/img3.png)
  ...
  - 실사례
    ...
    ![img](../resources/img/0531/img4.png)

- Overfitting
  - overfit : 학습이 너무 많이 됐을때

  - underfit : 학습이 너무 안 됐을때

    ![img](../resources/img/0531/img7.png)

  - 해결방법 (Set a feature)

    ![img](../resources/img/0531/img6.png)

    - Get more training data : 커피에 물을 추가하면 커피가 연해지는 것
    - Smaller set of features : 차원을 줄임으로서 속성이 가지는 의미를 명확히 하는 것 

    -  Add additional features : underfit일 때, 의미를 가지는 feature를 추가한다.

  - 해결방법 (Regularization / Add term to loss)

    ![img](../resources/img/0531/img8.png)

    - 큰 특정값을 정규화

- Summary

  ![img](../resources/img/0531/img9.png)
